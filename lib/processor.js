...
class Processor {
        ...
        css.walkAtRules(rule => {
            if (rule.name === 'keyframes') {
                if (!this.disabled(rule)) {
                    return keyframes != null ? keyframes.process(rule) : undefined;
                }
            } else if (rule.name === 'viewport') {
                if (!this.disabled(rule)) {
                    return viewport != null ? viewport.process(rule) : undefined;
                }
                ...
                if (!this.disabled(rule)) {
                    return resolution != null ? resolution.process(rule) : undefined;
                }
            }
        });
  ...
  // Remove unnecessary pefixes
    ...
    // Selectors
        for (var checker of this.prefixes.remove.selectors) {
      ...
      // Values
            for (checker of this.prefixes.values('remove', unprefixed)) {
