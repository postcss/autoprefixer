...
### Why do I get an error when I build the autogenerated files?

Some users have reported a syntax error when running `bin/autoprefixer --update`,
but it's unclear why this happens. Specifying the coffee binary explicitly seems
to help, try this:
